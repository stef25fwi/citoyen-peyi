    ...
    final textTheme = GoogleFonts.plusJakartaSansTextTheme(
      const TextTheme(
        ...
        headlineMedium: TextStyle(
            fontSize: 32, fontWeight: FontWeight.w800, color: foreground),
        headlineSmall: TextStyle(
            fontSize: 24, fontWeight: FontWeight.w800, color: foreground),
        titleLarge: TextStyle(
            fontSize: 20, fontWeight: FontWeight.w800, color: foreground),
        titleMedium: TextStyle(
            fontSize: 16, fontWeight: FontWeight.w700, color: foreground),
        titleSmall: TextStyle(
            fontSize: 14, fontWeight: FontWeight.w700, color: foreground),
